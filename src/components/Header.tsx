...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'services', 'about', 'testimonials', 'booking', 'contact'];
      ...
      <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          {navItems.map((item) => (
            <a 
              ...
              className={cn(
                ...
                isScrolled 
                  ? (activeSection === item.href.substring(1) ? "text-dental-primary" : "text-dental-dark") 
                  : (activeSection === item.href.substring(1) ? "text-dental-secondary" : "text-white"),
        ...
        <button 
          ...
          className={cn(
            ...
            isScrolled ? "text-dental-primary bg-gray-100" : "text-white bg-white/10"
          )}
        >
