    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            Your Smile,{" "}
            <span className="text-dental-secondary italic">Our Passion</span>
          </h1>
          <p
          ...
          >
            Experience exceptional dental care in a comfortable and modern
            environment. Our team of experts is dedicated to providing the
            highest quality treatments, tailored to your unique needs.
          </p>
          <div
