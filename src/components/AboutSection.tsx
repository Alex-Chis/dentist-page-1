      ...
      <div className="section-container relative">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-8 md:-right-8 bg-dental-primary p-8 rounded-lg shadow-xl transform hover:scale-105 transition-transform duration-300">
          ...
          >
            <span className="text-dental-primary font-medium uppercase tracking-wider">
              About Us
            </span>
            <h2 className="heading-lg mb-6 mt-2">
              Why Choose Our{" "}
              <span className="text-dental-primary">Dental Clinic</span>?
            </h2>

            <p className="text-gray-600 mb-8 leading-relaxed">
              At DentalCare, we combine advanced technology with compassionate
              care to deliver exceptional dental services. Our state-of-the-art
              facility and experienced team ensure that your dental health is in
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our dentists bring years of experience and specialized
                    training to provide exceptional care that ensures your
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    precise diagnosis, effective treatments, and comfortable
                    patient experience.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    We prioritize your comfort and satisfaction throughout every
                    step of your dental journey with personalized care and
                    attention.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    From preventive care to complex procedures, we provide all
                    the dental services you need in one convenient location.
                  </p>
                </div>
              </div>
            </div>
